...
const Navbar = () => {
	...
	return (
		<NavbarWrapper data-is-nav-hidden={isNavbarVisible ? undefined : true}>
			<NavbarItems className="--flex-column --flex-centered">
								...
								return (
									...
									>
										<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
											<path
												d="m21.5 23h-19c-1.378 0-2.5-1.122-2.5-2.5v-17c0-1.378 1.122-2.5 2.5-2.5h19c1.378 0 2.5 1.122 2.5 2.5v17c0 1.378-1.122 2.5-2.5 2.5zm-19-21c-.827
				...
				<NavbarItem className="--align-bottom">
					<NavbarNavigationItems>
						...
						<NavigationButton title="Logout" onClick={logoutButtonHandler}>
			...
			<NavbarHambuerguerButton className="--align-bottom" onClick={navbarVisibilityHandler}>
